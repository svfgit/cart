 ...
 */
 angular.module('utoo').controller('todoCtrl', function ($scope) {
 	$scope.todos = [
 	{text:'Meeting with Modi.', done:false, id: 'option1'}, 
 	{text:'Exercise at 6:pm.', done:false, id: 'option3'},         
 	{text:'Avengers Age of Ultron.', done:false, id: 'option4'},         
 	{text: 'Stevie birthday at Mezbaan.', done:false, id: 'option5'}
 	];
 	function makeid()
 	{
 		var text = "";
