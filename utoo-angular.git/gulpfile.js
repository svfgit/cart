...
gulp.task('font', function() {
  return gulp.src('bower_components/angular-ui-grid/*')
    .pipe($.filter('**/*.{eot,svg,ttf,woff,woff2}'))
    .pipe(gulp.dest('dist/styles'))
    .pipe(gulp.dest('app/styles'))
    .pipe(gulp.dest('.tmp/styles'));
...
gulp.task('serve', ['wiredep', 'connect', 'fonts', 'font', 'watch'], function() {
  if (argv.open) {
...
gulp.task('builddist', ['jshint', 'html', 'images', 'fonts', 'lang', 'font', 'extras', 'styles'],
  function() {
